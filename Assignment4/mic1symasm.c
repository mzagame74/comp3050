...
// has been extended to include the MULT, RSHIFT and
// DIV 10 bit opcodes (HALT also moved to 10 bit)
...
#define STR 	29
#define MULT 	30		// ***********************************
#define RSHIFT 	31		// *** three new microinstructions ***
#define DIV 	32		// ***********************************
