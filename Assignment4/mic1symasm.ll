...
#define			LOC	  	  28
#define			STR	  	  29
#define			MULT	  30			// three new microinstructions
#define			RSHIFT	  31
#define			DIV		  32
%}
...
[Mm][Uu][Ll][Tt]                       return(MULT);		// mult instruction

[Rr][Ss][Hh][Ii][Ff][Tt]               return(RSHIFT);	// rshift instruction

[Dd][Ii][Vv]						   return(DIV);			// div instruction
